...
<div class="container">
	<form enctype="multipart/form-data" name="cadastroempresa" id="cadastroempresa" method="post" action="{{route('funcionario.store')}}" class="form-horizontal formularios">
		@csrf

		<div class="row justify-content-center">
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">Novo Funcionário(a)</div>
